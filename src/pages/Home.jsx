...
// 🖼️ Import Assets
import photo from '../../public/vishal.jpg'
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
            Java Full Stack Developer | Spring Boot Specialist | Web Technology Enthusiast
          </p>
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '💼 Expertise', value: 'Java Full Stack, Spring Boot, React' },
              { label: '📧 Contact', value: 'thatvishal007@gmail.com' },
            ].map((info, i) => (
