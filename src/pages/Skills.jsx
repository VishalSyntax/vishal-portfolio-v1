...
const ROWS = [
  [
    { title: "Backend Technologies", items: ["Java", "Spring Boot", "Servlet/JSP", "Spring Security"] },
    { title: "Frontend Technologies", items: ["React.js", "JavaScript", "HTML5", "CSS3", "Bootstrap"] },
    { title: "Databases", items: ["MySQL", "PostgreSQL", "JDBC", "Hibernate"] },
    { title: "Tools & APIs", items: ["Maven", "Git", "REST API", "Postman"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Problem Solving", "Team Collaboration", "Code Review", "Communication"],
    },
  ],
];
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ☕ Java Full Stack expertise with modern frameworks — explore my technical competencies below.
        </p>
      </motion.div>
